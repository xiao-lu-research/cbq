        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(xb_common, 
                            ...
                            (multiply(stan::model::rvalue(X_common, stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "X_common"), beta_common) + get_base1(beta_wave, get_base1(wave, i, "wave", 1), "beta_wave", 1)), 
